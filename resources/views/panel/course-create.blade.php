                        ...
                        <form action="{{Route('course.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group mb-4 col col-xl-6 col-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="در صورت رایگان بودن دوره عدد صفر را به عنوان قیمت وارد کنید."  name="price" value="{{old('price')}}"
                                           id="exampleFormControlInput2">
                                </div>
                                <div class="form-group mb-4 col col-xl-6 col-12">
                            ...
                            <div class="form-group mb-4">
                            برای بارگذاری فایل های دوره پس از ثبت دوره به صفحه دوره ها بروید و بر روی گزینه <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-folder"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg> کلیک کنید.
                            </div>
{{--                            <div class="form-group mb-4">--}}
{{--                                <label>--}}
