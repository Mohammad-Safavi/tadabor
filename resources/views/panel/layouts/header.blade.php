<div class="header-container fixed-top">
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item flex-row navbar-dropdown ml-auto">
            ...
            <li style="position:absolute !important;left: 3px; bottom: 20px;" class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                    ...
                    <div style="text-align: right !important;" class="dropdown-item">
                        <a href="{{Route('user.index')}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> <span>اطلاعات کاربری</span>
                        </a>
                    </div>
                    <div style="text-align: right !important;" class="dropdown-item">
                        <a href="{{Route('change.password-view')}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> <span>ویرایش رمز عبور</span>
                        </a>
                    </div>
                    <div style="text-align: right !important;" class="dropdown-item">
