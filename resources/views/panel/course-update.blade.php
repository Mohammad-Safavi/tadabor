                        ...
                        <form action="{{ Route('course.update', $course->id) }}" method="post"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control" value="{{ $course->title }}"
                                    onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)" name="title"
                            ...
                            <div class="row">
                                <div class="form-group mb-4 col col-xl-6 col-12">
                                    ...
                                    <input type="text" class="form-control" value="{{ $course->slug }}" id="slug"
                                        name="slug" id="exampleFormControlInput2">
                                </div>
                                <div class="form-group mb-4 col col-xl-6 col-12">
                                    <label for="exampleFormControlInput2">کلمات کلیدی</label>
                                    <input type="text" class="form-control" value="{{ $course->keyword }}" name="keyword"
                                        placeholder="کلمه اول , کلمه دوم , کلمه سوم , ...." id="exampleFormControlInput2">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group mb-4 col col-xl-6 col-12">
                            ...
                            <div class="form-group mb-4">
                                <img src="{{ asset('uploads/course-picture' . $course->name_pic) }}" width="200"
                                    alt="{{ $course->title }}"><br><br>
