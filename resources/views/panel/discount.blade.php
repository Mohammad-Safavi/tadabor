...
@section('content')
                    ...
                    <div class="widget-content-area br-4">
                        <form action="{{ Route('discount.store') }}" method="post">
                            ...
                            <div class="form-group mb-4">
                                <label>کد</label>
                                <input type="text" class="form-control" id="tyds" name="code">
                            </div>
                            <button type="button" class="btn btn-info" onclick="ccd23(6)">تولید کد تصادفی</button>
                            <div class="form-group w-50 mt-3 mb-4">
                                <label>مقدار تخفیف</label>
                                ٪<input type="text" class="form-control" placeholder="از ۱ تا ۹۹" name="value">
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <ul class="table-controls">
                                                            ...
                                                            <li>
                                                                <form
                                                                    action="{{ Route('discount.delete', $discount->id) }}"
    ...
    <script>
        function ccd23(length) {
            ...
            document.getElementById('tyds').value = result;
        }
    </script>
@endsection
