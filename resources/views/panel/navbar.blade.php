...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6 col-sm-6 col-12">
                                    <button style="float: left" class="btn btn-primary" data-toggle="modal"
                                        data-target="#addnavbar">اضافه کردن آدرس</button>
                                </div>
                            </div>
                            <br>
    ...
    <div class="modal fade" id="mynavbar" tabindex="-1" role="dialog"
     ...
     <div class="modal fade" id="addnavbar" tabindex="-1" role="dialog"
         aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">اضافه کردن آدرس</h4>
                    <a href="#" data-dismiss="modal" aria-label="Close" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                            <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z"></path>
                        </svg></a>
                </div>
                <div class="modal-body">
                    ...
                    <form action="{{Route('navbar.store')}}"
                          method="POST"
                          onsubmit="FormSubmit(this);">
                        @csrf
                        <input type="hidden" id="nav_id" name="nav_id" value="">
